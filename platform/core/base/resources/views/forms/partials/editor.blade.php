    ...
    <div style="height: 34px;">
        ...
        @if (function_exists('shortcode') && Arr::get($attributes, 'with-short-code', false) == true)
            <div class="d-inline-block editor-action-item list-shortcode-items">
                <div class="dropdown">
                    <button class="btn btn-primary dropdown-toggle add_shortcode_btn_trigger" data-result="{{ $result }}" type="button" data-toggle="dropdown" hidden><i class="fa fa-code"></i> {{ trans('core/base::forms.short_code') }}
                    </button>
