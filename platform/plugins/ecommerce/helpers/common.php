...
if (!function_exists('returnResponse')) {
    function returnResponse($status, $code = null, $url = null, $message = null, $data = [], $function = null) {
        /** This will check header or any request call, So in api we request for application/json. **/
...
if (!function_exists('sendMail')) {
    ...
    function sendMail($to, $subject, $data, $view) {
        try {
