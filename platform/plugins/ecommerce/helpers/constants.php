...
if (!defined('BOOKED_SERVICE_MODULE_SCREEN_NAME')) {
    define('BOOKED_SERVICE_MODULE_SCREEN_NAME', 'booked-service');
}
...
if (!defined('RENDER_SERVICES_IN_CHECKOUT_PAGE')) {
    define('RENDER_SERVICES_IN_CHECKOUT_PAGE', 'render_services_in_checkout_page');
}
