...
return [
    ...
    'form'                                           => [
        ...
        'price'                              => 'Price',
        'quantity'                           => 'Quantity',
        'min_quantity'                       => 'Min Order quantity',
        'brand'                              => 'Brand',
        'width'                              => 'Width',
        'height'                             => 'Height',
        'weight'                             => 'Weight',
    ...
    'service_create_validate_name_required'          => 'Please enter service name',
    'service_create_validate_price_required'         => 'Please enter service price',
    'service_create_validate_end_date_after'         => 'End date must be after start date',
    'service_create_validate_start_date_required_if' => 'start date cannot be left blank when service type is hourly selected',
