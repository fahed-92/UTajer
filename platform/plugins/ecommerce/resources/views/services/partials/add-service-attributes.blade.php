@if ($serviceAttributeSets->count() > 0)
    <div class="add-new-product-attribute-wrap">
        ...
        <div class="list-product-attribute-values-wrap hidden">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="next-input product-select-attribute-item">
                                    @foreach ($serviceAttributeSets as $item)
            ...
            @foreach ($serviceAttributeSets as $attributeSet)
        ...
        <div class="list-product-attribute-wrap hidden">
            ...
            <a href="#" class="btn btn-secondary btn-trigger-add-attribute-item @if ($serviceAttributeSets->count() < 2) hidden @endif">{{ trans('plugins/ecommerce::products.form.add_more_attribute') }}</a>
            @if ($services && is_object($service) && $service->id)
...
@else
    <p>{!! trans('plugins/ecommerce::products.form.create_product_variations', ['link' => Html::link(route('services.create'), trans('plugins/ecommerce::products.create_new_service'))]) !!}</p>
@endif
