...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(['prefix' => BaseHelper::getAdminPrefix() . '/ecommerce', 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'reports'], function () {
            ...
            Route::get('get-excel', [
                'as'         => 'ecommerce.report.get-excel',
                'uses'       => 'ReportController@getExcel',
                'permission' => 'ecommerce.report.get-excel',
            ]);
        });
...
Route::group(['namespace' => 'Botble\Ecommerce\Http\Controllers\Fronts', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::get('/categories', 'PublicProductCategoryController@getCategories')->name('public.categories');
        ...
        Route::get('service-details/{id}', [
            'uses' => 'PublicServiceController@getServiceDetails',
            'as'   => 'public.service-details',
        ]);
        Route::get(SlugHelper::getPrefix(Service::class, 'services'), [
            'uses' => 'PublicServiceController@getServices',
            'as'   => 'public.services',
        ]);
        Route::post('service-book', [
            'uses' => 'PublicServiceController@bookService',
            'as'   => 'public.service.booking',
        ]);

        Route::get('service-checkout/{serviceToken}', [
            'uses' => 'PublicServiceController@serviceCheckout',
            'as'   => 'public.service.checkout',
        ]);
