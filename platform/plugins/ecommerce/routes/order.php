...
Route::group([
    ...
    Route::post('appOrderHistory', 'OrderController@appOrderHistory')->name('appOrderHistory.post');
    Route::post('appOrderCreate', 'OrderController@appOrderCreate')->name('appOrderCreate.post');
    Route::post('downloadInvoice', 'OrderController@downloadInvoice')->name('downloadInvoice.post');
    Route::post('orderPlacedConfirmation', 'OrderController@orderPlacedConfirmation')->name('orderPlacedConfirmation.post');
    Route::post('orderHistoryDetails', 'OrderController@orderHistoryDetails')->name('orderHistoryDetails.post');
});
