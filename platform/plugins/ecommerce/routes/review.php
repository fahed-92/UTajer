...
Route::group([
    ...
    Route::post('addReview', 'ReviewController@addReview')->name('addReview.post');
    Route::post('productReviewList', 'ReviewController@productReviewList')->name('productReviewList.post');
});
