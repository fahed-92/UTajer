...
use Botble\Ecommerce\Facades\ServiceBookingFacade;
...
use Botble\Ecommerce\Repositories\Caches\BookedServiceCacheDecorator;
...
use Botble\Ecommerce\Repositories\Caches\ServiceCacheDecorator;
use Botble\Ecommerce\Repositories\Caches\ServiceCategoryCacheDecorator;
...
use Botble\Ecommerce\Repositories\Eloquent\BookedServiceRepository;
...
use Botble\Ecommerce\Repositories\Eloquent\ServiceCategoryRepository;
use Botble\Ecommerce\Repositories\Eloquent\ServiceRepository;
...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(BookedServiceInterface::class, function () {
            return new BookedServiceCacheDecorator(
                new BookedServiceRepository(new ServiceBooking())
            );
        });
        $this->app->bind(ServiceCategoryInterface::class, function () {
            return new ServiceCategoryCacheDecorator(
                new ServiceCategoryRepository(new Service())
            );
        });
        ...
        $loader->alias('ServiceBooking', ServiceBookingFacade::class);
    ...
    public function boot()
    {
        ...
        SlugHelper::setPrefix(ServiceBooking::class, 'Service Booking');
        ...
        if (defined('LANGUAGE_MODULE_SCREEN_NAME') && defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
            ...
            LanguageAdvancedManager::registerModule(ServiceBooking::class, [
                'user_id',
                'service_id',
            ]);
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    ...
                    'priority'    => 0,
                    'parent_id'   => 'cms-plugins-ecommerce-cm',
                ...
                ->registerItem([
                    'id'          => 'cms-plugins-ecommerce-services',
                    'priority'    => 7,
                    'parent_id'   => 'cms-plugins-ecommerce',
                    'name'        => 'plugins/marketplace::bookedService.name',
                    'icon'        => 'fa fa-shopping-bag',
                    'url'         => route('marketplace.booked-service.index'),
        ...
        Event::listen(['cart.removed', 'cart.stored', 'cart.restored', 'cart.updated' ,'service_booking.removed'], function ($cart) {
