...
trait BookedServiceActionsTrait
{
    ...
    public function __construct(BookedServiceInterface $serviceRepository) {
    ...
    public function destroy($id, Request $request, BaseHttpResponse $response)
    {
        ...
        try {
            ...
            event(new DeletedContentEvent(BOOKED_SERVICE_MODULE_SCREEN_NAME, $request, $service));
    ...
    public function postCreateServiceWhenCreatingOrder(
        ...
        event(new CreatedContentEvent(BOOKED_SERVICE_MODULE_SCREEN_NAME, $request, $product));
