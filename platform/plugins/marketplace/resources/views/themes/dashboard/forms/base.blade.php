...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var categorySelect = document.querySelector('[value="other_category"]');
            var otherCategoryInput = document.getElementById('otherCategoryInput');
            otherCategoryInput.parentElement.parentElement.style.display = 'none';

            console.log("otherCategoryInput === >", otherCategoryInput.parentElement.parentElement )
            categorySelect.addEventListener('change', function () {
                 if (categorySelect.checked === true) {
                     otherCategoryInput.parentElement.parentElement.style.display = 'block';
                } else {
                     otherCategoryInput.parentElement.parentElement.style.display = 'none';
                }
            });
