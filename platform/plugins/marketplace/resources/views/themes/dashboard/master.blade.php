...
<head>
    ...
    <link media="all" type="text/css" rel="stylesheet" href="/themes/martfury/css/style.css?v=1.12.0">
...
{{--                    </div>--}}
{{--                    <div class="ps-block__action"><a href="{{ route('customer.logout') }}"><i class="icon-power-switch"></i></a></div>--}}
{{--                </div>--}}
...
<script src="{{ asset('themes/martfury/js/marketplace_style.js') }}"></script>
