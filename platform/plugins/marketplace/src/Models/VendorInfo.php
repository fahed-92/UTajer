...
//                dd($balanceOriginal,$balanceOriginal,$totalFeeOriginal,$totalFee,$totalRevenueOriginal,$totalRevenue);
                if ($balanceOriginal != $balanceOriginal || $totalFeeOriginal != $totalFee || $totalRevenueOriginal != $totalRevenue) {
//                dd($balanceOriginal,$balanceOriginal,$totalFeeOriginal,$totalFee,$totalRevenueOriginal,$totalRevenue);
