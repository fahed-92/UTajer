    ...
    public function boot()
    {
        if (is_plugin_active('ecommerce')) {
            $this->setNamespace('plugins/marketplace')
                ...
                ->loadAndPublishViews()
                ->publishAssets()
                ->loadRoutes(['base', 'fronts', 'product', 'order', 'discount','service']);
            ...
            Event::listen(RouteMatched::class, function () {
                dashboard_menu()
                    ...
                    ->registerItem([
                        'id'          => 'cms-plugins-ecomerce.service',
                        'priority'    => 2,
                        'parent_id'   => 'cms-plugins-marketplace',
                        'name'        => 'plugins/marketplace::service.name',
                        'icon'        => null,
                        'url'         => route('marketplace.service.index'),
                        'permissions' => ['marketplace.service.index'],
                    ])
                    /*->registerItem([
        ...
        Form::component('customImageFile', 'plugins/marketplace::themes.dashboard.forms.partials.custom-image-file', [
            'name',
            'value'      => null,
            'attributes' => [],
        ]);
