...
//            })
            ...
            ->addColumn('operations', function ($item) {
                return view('plugins/marketplace::themes.dashboard.table.actions', [
                    'edit'   => 'marketplace.booked-service.edit',
                    'delete' => 'marketplace.booked-service.destroy',
                    'item'   => $item,
                ])->render();
            });
...
//            ],
    ...
    {
//        return $this->addCreateButton(route('marketplace.booked-service.create'));
    }
    ...
    {
        return $this->addDeleteAction(route('marketplace.booked-service.deletes'), null, parent::bulkActions());
    }
