...
app()->booted(function () {
    theme_option()
        ->setField([
            ...
            'attributes' => [
                'name'    => 'copyright',
                'value'   => '© 2023 Etana. All right reserved.',
                'options' => [
                    'class'        => 'form-control',
        ...
        ->setField([
            'id'         => 'show_featured_services_on_services_page',
            'section_id' => 'opt-text-subsection-ecommerce',
            'type'       => 'select',
            'label'      => __('Show featured Services on the Service page?'),
            'attributes' => [
                'name'    => 'show_featured_services_on_service_page',
                'list'    => [
                    'no'  => trans('core/base::base.no'),
                    'yes' => trans('core/base::base.yes'),
                ],
