<div class="ps-product__thumbnail"><a href="javascript:void(0)"><img src="{{ RvMedia::getImageUrl($product->image, 'small', false, RvMedia::getDefaultImage()) }}" alt="{{ $product->name }}"></a>
    ...
    @else
        ...
        @endif
    @endif
    <ul class="ps-product__actions testing">
       ...
       <!--  <li><a class="js-add-to-wishlist-button" href="#" data-url="{{ route('public.wishlist.add', $product->id) }}" title="{{ __('Add to Wishlist') }}"><i class="icon-heart"></i></a></li> -->
        <li><a class="js-add-to-wishlist-button" href="#" data-url="#" title="{{ __('Add to Wishlist') }}"><i class="icon-heart"></i></a></li>
...
<div class="ps-product__container">
    <div class="price_cart">
        ...
        <ul class="ps-product__actions testing">
            ...
            <li><a class="add-to-cart-button" data-id="{{ $product->id }}" href="#" data-url="#" title="{{ __('Add To Cart') }}"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
        </ul>
    </div>
    ...
    <div class="ps-product__content">
        @if (is_plugin_active('marketplace') && $product->store->id)
            <p class="ps-product__vendor">
                ...
                <a href="javascript:void(0)" class="text-uppercase">{{ $product->store->name }}</a>
            </p>
        @endif
        <a class="ps-product__title" href="javascript:void(0)">{{ $product->name }}</a>
