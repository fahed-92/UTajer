                    ...
                    <aside class="ps-widget--account-dashboard">
                        <div class="ps-widget__header">
                            ...
                            <figure>
                                ...
                                <p><a href="javascript:void(0)">{{ auth('customer')->user()->email }}</a></p>
                            </figure>
                        </div>
                        <div class="ps-widget__content">
                            <ul>
                                ...
                                <li @if (Route::currentRouteName() == 'customer.services' || Route::currentRouteName() == 'customer.services.view') class="active" @endif><a href="{{ route('customer.services') }}"><i class="icon-papers"></i> {{ __('services') }}</a></li>
                                ...
                                @if (is_plugin_active('marketplace'))
                                    ...
                                    @endif
                                @endif
                                <li><a href="{{ route('customer.logout') }}" onclick="return confirm('Sure, you want logout?');"><i class="icon-power-switch"></i>{{ __('Logout') }}</a></li>
                            </ul>
                        </div>
                    </aside>
                </div>
