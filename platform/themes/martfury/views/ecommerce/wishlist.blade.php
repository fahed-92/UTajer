                    ...
                    <tbody>
                        @if (auth('customer')->check())
                            @foreach ($wishlist as $item)
                                ...
                                <tr>
                                    <td data-label="{{ __('Remove') }}">&nbsp;<a class="js-remove-from-wishlist-button" data-toggle="tooltip" data-placement="bottom" title="Remove from whishlist" href="#" data-url="{{ route('public.wishlist.remove', $product->id) }}"><i class="icon-cross"></i></a></td>
