    ...
    <div style="margin: 40px 0;">
        ...
        <div style="margin: 20px 0;">
            ...
            <div style="border: 1px solid rgba(0,0,0,.1); padding: 10px; margin-top: 10px;">
                ...
                <div>[flash-sale title="Suggested Products" flash_sale_id="1"][/flash-sale]</div>
                ...
                <div>[featured-products title="Top products"][/featured-products]</div>
                <div>[theme-ads key_1="Q9YDUIC9HSWS" key_2="Q9YDUIC9HSWS"][/theme-ads]</div>
                <div>[product-collections title="New Products"][/product-collections]</div>
                <div>[product-category-products category_id="17"][/product-category-products]</div>
		<div>[download-app title="Download Etana App Now!" subtitle="Shopping fastly and easily more with our app. Get a link to download the app on your phone." screenshot="general/app.png" android_app_url="https://www.appstore.com" ios_app_url="https://play.google.com/store"][/download-app]</div>
